...
// src/domain/application/usecases/fetch-companies-by-manager/fetch-companies-by-manager.spec.ts
...
var FetchCompaniesByManagerUseCase = class {
  constructor(managerRepository2, companyRepository2) {
...
describe("Fetch Companies By Manager Use Case", () => {
  ...
  it("should be able to fetch all companies created by a unique manager", async () => {
    const managerId = new UniqueId(import_faker3.faker.string.uuid());
